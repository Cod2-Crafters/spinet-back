...
public class QCategory extends EntityPathBase<Category> {
    ...
    private static final long serialVersionUID = 899964919L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCategory category = new QCategory("category");

    public final SetPath<Category, QCategory> childList = this.<Category, QCategory>createSet("childList", Category.class, QCategory.class, PathInits.DIRECT2);
